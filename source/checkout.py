...
def checkout():
    ...
    response3 = requests.get("http://cardvault.csw.lab:8996/get_credit_card")
    response4 = requests.post("http://payment.csw.lab:8992/payment", headers={"Content-Type": "application/json"}, json={"amount": 100})
